...
plotTiTv = function(res = NULL, plotType = 'both', file = NULL, width = 6, height = 5,
                    color = NULL, showBarcodes = FALSE, textSize = 2, baseFontSize = 1, axisTextSize = c(1, 1)){
  ...
  if(plotType == 'bar'){
    ...
    b = boxplot(value ~ variable, data = titv.frac.melt, axes = FALSE, xlab = "", ylab = "", col = col[levels(titv.frac.melt[,variable])],
                names=NA, lty = 1, staplewex = 0, pch = 16, xaxt="n", notch = TRUE,
    ...
    layout(mat = matrix(data = c(1, 2, 3, 3), byrow = TRUE, nrow = 2), widths = c(4, 2))
    par(mar = c(2, 4, 2, 1))
    b = boxplot(value ~ variable, data = titv.frac.melt, axes = FALSE, xlab = "", ylab = "", col = col[levels(titv.frac.melt[,variable])],
                names=NA, lty = 1, staplewex = 0, pch = 16, xaxt="n", notch = TRUE,
                outcex = 0.6, outcol = "gray70", ylim = c(0, 100), lwd = 0.6)
